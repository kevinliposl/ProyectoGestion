...
CREATE TABLE `tbevent` (
  ...
  `eventplace` varchar(50) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `eventdate` date NOT NULL,
  `eventhour` time NOT NULL,
  `dayafter` int(11) NOT NULL,
  `daybefore` int(11) NOT NULL,
  `eventestate` smallint(6) NOT NULL DEFAULT '1',
