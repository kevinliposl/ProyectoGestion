...
<table>
    ...
    foreach ($event as $event) {
        ...
        echo "</td>";
        echo "<td>";
        echo "<input type ='number' name='hourAfter' value='" . $event['eventdayafter'] . "' min='0' step='1'/>";
        echo "</td>";
        echo "<td>";
        echo "<input type ='number' name='hourBefore' value='" . $event['eventdaybefore'] . "' min='0' step='1'/>";
        echo "</td>";
        echo "<td>";
        echo "<input type ='number' name='eventenclosureid' value='" . $event['activityenclosureid'] . "' min='0' step='1'/>";
        echo "</td>";
        echo "<td>";
