...
if (SSession::getInstance()->user['type'] == "student") {//estudiante
    ...
    if (SSession::getInstance()->user['actorid']) {
        ...
        echo "</td>";
        echo "<td>";
        echo "<input pattern = "."[A-Za-z0-0]{5,11}"." type ='text' name='studentlicense' value='" . SSession::getInstance()->user['studentlicense'] . "'/>";
        echo "</td>";
        echo "<td>";
        echo "<input type = 'hidden' name='studentid' value='" . SSession::getInstance()->user['studentid'] . "'/>";
        echo "<input pattern = "."[A-Za-záéíóúÁÉÍÓÚÑñ]{3,50}"." type = 'text' name='studentname' value='" . SSession::getInstance()->user['studentname'] . "' pattern ='[a-zA-Z\s]+$'/>";
        echo "</td>";
        echo "<td>";
        echo "<input pattern= "."[A-Za-z0-9áéíóúÁÉÍÓÚÑñ]{3,50}"."type ='text' name='studentlastname1' value='" . SSession::getInstance()->user['studentlastname1'] . "' pattern ='[a-zA-Z\s]+$'/>";
        echo "</td>";
        echo "<td>";
        echo "<input pattern= "."[A-Za-z0-9áéíóúÁÉÍÓÚÑñ]{3,50}"." type ='text' name='studentlastname2' value='" . SSession::getInstance()->user['studentlastname2'] . "' pattern ='[a-zA-Z\s]+$'/>";
        echo "</td>";
        echo "<td>";
    ...
    if (SSession::getInstance()->user['actorid']) {
        ...
        echo "</td>";
        echo "<td>";
        echo "<input pattern = "."[A-Za-z0-0]{5,11}"." type ='text' name='professorlicense' value='" . SSession::getInstance()->user['professorlicense'] . "'/>";
        echo "</td>";
        echo "<td>";
        echo "<input type = 'hidden' name='professorid' value='" . SSession::getInstance()->user['professorid'] . "'/>";
        echo "<input pattern = "."[A-Za-záéíóúÁÉÍÓÚÑñ]{3,50}"." type = 'text' name='professorname' value='" . SSession::getInstance()->user['professorname'] . "' pattern ='[a-zA-Z\s]+$'/>";
        echo "</td>";
        echo "<td>";
        echo "<input pattern = "."[A-Za-záéíóúÁÉÍÓÚÑñ]{3,50}"." type ='text' name='professorlastname1' value='" . SSession::getInstance()->user['professorlastname1'] . "' pattern ='[a-zA-Z\s]+$'/>";
        echo "</td>";
        echo "<td>";
        echo "<input pattern = "."[A-Za-záéíóúÁÉÍÓÚÑñ]{3,50}"." type ='text' name='professorlastname2' value='" . SSession::getInstance()->user['professorlastname2'] . "' pattern ='[a-zA-Z\s]+$'/>";
        echo "</td>";
        echo "<td>";
